...
Every preset in two orientations, side and top, rendered by
`tests/make_gallery.py`. The command under each one is what produces that
scene: paste it into the PyMOL command line after loading the system and
the protocol.
...
| side | top |
|---|---|
| ![preset_prot1 lado](img/prot1_lado.png) | ![preset_prot1 cima](img/prot1_cima.png) |
...
| side | top |
|---|---|
| ![preset_prot2 lado](img/prot2_lado.png) | ![preset_prot2 cima](img/prot2_cima.png) |
...
| side | top |
|---|---|
| ![preset_prot3 lado](img/prot3_lado.png) | ![preset_prot3 cima](img/prot3_cima.png) |
...
| side | top |
|---|---|
| ![preset_prot4 lado](img/prot4_lado.png) | ![preset_prot4 cima](img/prot4_cima.png) |
...
| side | top |
|---|---|
| ![preset_prot5 lado](img/prot5_lado.png) | ![preset_prot5 cima](img/prot5_cima.png) |
...
| side | top |
|---|---|
| ![preset_prot6 lado](img/prot6_lado.png) | ![preset_prot6 cima](img/prot6_cima.png) |
...
| side | top |
|---|---|
| ![preset_prot7 lado](img/prot7_lado.png) | ![preset_prot7 cima](img/prot7_cima.png) |
...
| side | top |
|---|---|
| ![preset_prot8 lado](img/prot8_lado.png) | ![preset_prot8 cima](img/prot8_cima.png) |
...
| side | top |
|---|---|
| ![preset_prot9 lado](img/prot9_lado.png) | ![preset_prot9 cima](img/prot9_cima.png) |
...
| side | top |
|---|---|
| ![preset_prot10 lado](img/prot10_lado.png) | ![preset_prot10 cima](img/prot10_cima.png) |
...
| side | top |
|---|---|
| ![preset_memb1 lado](img/memb1_lado.png) | ![preset_memb1 cima](img/memb1_cima.png) |
...
| side | top |
|---|---|
| ![preset_memb2 lado](img/memb2_lado.png) | ![preset_memb2 cima](img/memb2_cima.png) |
...
| side | top |
|---|---|
| ![preset_memb3 lado](img/memb3_lado.png) | ![preset_memb3 cima](img/memb3_cima.png) |
...
| side | top |
|---|---|
| ![preset_memb4 lado](img/memb4_lado.png) | ![preset_memb4 cima](img/memb4_cima.png) |
...
| side | top |
|---|---|
| ![preset_memb5 lado](img/memb5_lado.png) | ![preset_memb5 cima](img/memb5_cima.png) |
...
| side | top |
|---|---|
| ![preset_memb6 lado](img/memb6_lado.png) | ![preset_memb6 cima](img/memb6_cima.png) |
...
| side | top |
|---|---|
| ![preset_memb7 lado](img/memb7_lado.png) | ![preset_memb7 cima](img/memb7_cima.png) |
...
| side | top |
|---|---|
| ![preset_memb8 lado](img/memb8_lado.png) | ![preset_memb8 cima](img/memb8_cima.png) |
...
| side | top |
|---|---|
| ![preset_memb9 lado](img/memb9_lado.png) | ![preset_memb9 cima](img/memb9_cima.png) |
...
| side | top |
|---|---|
| ![preset_memb10 lado](img/memb10_lado.png) | ![preset_memb10 cima](img/memb10_cima.png) |
